...
<form method="POST" action="proses_pembelian.php">
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nomor" name="tanggal" type="date" class="form-control"
  ...
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Produk ID</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="nomor" name="produk_id" type="text" class="form-control" 
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nomor" name="harga" type="text" class="form-control" 
        value="<?php if(isset($row['harga'])) echo $row['harga']; ?>">
      </div>
    </div>
  </div>
  <div class="form-group row">
    <label for="nama" class="col-4 col-form-label">Vendor ID</label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
        ...
        <input id="nomor" name="vendor_id" type="text" class="form-control" 
